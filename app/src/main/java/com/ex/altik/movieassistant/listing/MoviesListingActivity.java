...
import com.ex.altik.movieassistant.Constants;
import com.ex.altik.movieassistant.Movie;
import com.ex.altik.movieassistant.R;
import com.ex.altik.movieassistant.details.MovieDetailsActivity;
import com.ex.altik.movieassistant.details.MovieDetailsFragment;
...
public class MoviesListingActivity extends AppCompatActivity implements MoviesListingFragment.Callback {
    ...
    private void setToolbar() {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle(R.string.movie_assistant);
